    ...
    <div className="bg-white border-b border-gray-200">
      <div className="flex">
        ...
        <button
          ...
          className={`flex-1 px-6 py-3 text-center font-semibold text-base transition-all duration-200 relative ${
            activeTab === 'team2'
              ? 'bg-gradient-to-r from-amber-600 to-orange-600 text-white border-b-4 border-amber-600 shadow-lg'
              : 'bg-gradient-to-r from-gray-50 to-gray-100 text-gray-700 hover:from-amber-50 hover:to-orange-50 hover:text-amber-700'
          }`}
        >
          <div className="flex items-center justify-center space-x-2">
            <span className="text-xl">🏏</span>
          ...
          {activeTab === 'team2' && (
            <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent border-t-amber-600"></div>
          )}
        </button>
      </div>
    </div>
