        ...
        <div className="text-center">
          ...
          <div className="flex items-center justify-center space-x-3 mb-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-600 font-medium">Live Cricket Action</p>
            </div>
          </div>
          
          {/* Info Lines */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 text-slate-600 text-xs mb-2">
